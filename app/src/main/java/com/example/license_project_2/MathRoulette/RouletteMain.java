...
public class RouletteMain extends AppCompatActivity {
    ...
    private static final String[] algebraProblems = {"Solve: x^2 + 5x + 6 = 0",
                                                     ...
                                                     "Solve  3e^x + 6 = 120", "If the sum of the square of two real numbers is 74 and their sum is 12. Then the sum of cubes of these two numbers is ...."};
    private static final String[] algebraAnswers = {"-2, -3", "(x-2)*(x-3)", "(x-2)^2", "x>-2", "x<25", "1.801, 0.447, -1.248", "-14/5", "8", "ln(38)", "468"};
    private static final String[] trigonometryProblems = {"If cosec(θ) + cot(θ) = x, find the value of cosec(θ) - cot(θ), using the trigonometry formula.",
                                                          "If sin(θ)*cos(θ) = 8, find the value of (sin(θ) + cos(θ))^2 using the trigonometry Formulas.",
                                                          "If sin(x) = 0.8, find the value of x in degrees.",
                                                          "If sin(2θ) = 0.6 and θ is in the first quadrant, find the value of θ in radians.",
                                                          "If sin(α) = 0.5 and cos(β) = 0.8, find sin(α + β).",
                                                          "Calculate the value of sin(135°) using trigonometric identities.",
                                                          "An electrician is climbing a 40 m long rope, which is tightly stretched and tied from the top of a vertical pole to the ground. Find the height of the pole if the angle made by the rope with the ground level is 60°.",
                                                          "What is the value of cos(-15°)?",
                                                          "If cos(x) = π/3, find the value of cos(3x) (in decimal form with two decimal digit precision).",
                                                          "Calculate the value of cos(120°)."};
    private static final String[] trigonometryAnswers = {"1/x", "17", "53.13", "0.32175", "0.92", "0.7071", "34.64", "0.9659", "-0.08", "-0.5"};
    private static final String[] calculusProblems = {"Differentiate the function f(x) = x^3 with respect to x.",
                                                      "Differentiate the function f(x) = (x+1)(x+2) with respect to x.",
                                                      "Differentiate the function f(x)=(x+1)/(x+2) with respect to x.",
                                                      "Differentiate the function f(x) = sin(x^2) with respect to x.",
                                                      "Calculate the derivative of f(x) = 3x^3.",
                                                      "Find the second-order derivative of f(x) = 4x^4 + 3x^3 + 2x^2 + x + 1",
                                                      "Determine the intervals where the function f(x)=x^3−6x^2+9x+15 is concave up and concave down.",
                                                      "Determine the intervals where the function g(x)=2x^4-4x^3-24x^2+48x is concave up and concave down.",
                                                      "Given y = x/(x^2 + 1). Find the value of the second derivative at x = 1",
                                                      "Given y(x) = 3x^3 + 12x + 4. Find the value of third derivative at x = 1"};
    private static final String[] calculusAnswers = {"3x^2", "2x+3", "1/(x+2)^2", "2xcos(x^2)", "9x^2", "48x^2+18x+4", "(-∞,1)∪(3,∞) ; (1,3)", "(-∞,-1)∪(3,∞) ; (-1,3)", "0.5", "18"};
    private static final String[] geometryProblems = {"Two triangles are similar. The sides of the first triangle are 6 cm, 8 cm, and 10 cm. The shortest side of the second triangle is 3 cm. Find the lengths of the other two sides of the second triangle.",
                                                      "In a right triangle, one leg is 9 cm and the hypotenuse is 15 cm. Find the length of the other leg.",
                                                      "Find the area of a triangle with sides 7 cm, 8 cm, and 9 cm.",
                                                      "In a triangle, one angle is 35 degrees and another angle is 65 degrees. Find the measure of the third angle.",
                                                      "In a quadrilateral ABCD, the measures of the angles are ∠A = 4x, ∠B = 3x+10∘, ∠C = 2x, and ∠D = x+20∘. Find the value of x and the measure of each angle.",
                                                      "The lengths of the adjacent sides of a parallelogram are 6cm and 7cm. Find its perimeter.",
                                                      "Three angles of a quadrilateral are 60°, 85°, 101°. Find out the fourth angle.",
                                                      "In parallelogram ABCD, if the diagonals intersect at right angles and the lengths of the diagonals are 12 cm and 16 cm, find the area of the parallelogram.",
                                                      "In parallelogram ABCD, if angle A = 3x + 10° and angle C = 2x + 30°, find the value of x.",
                                                      "In parallelogram PQRS, if PQ = 5x - 7, QR = 2x + 3, and PQ = QR, find the value of x."};
    private static final String[] geometryAnswers = {"4, 5", "12", "26.83", "80", "132, 109, 66, 53", "26", "114°", "96", "20", "10"};

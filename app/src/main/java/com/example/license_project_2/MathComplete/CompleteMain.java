...
public class CompleteMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        startEmoji = findViewById(R.id.startEmoji);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(wordProblemIndexTwo + 2 < requirements.length) {
                    ...
                    indexOne = wordProblemIndexOne;
                    indexTwo = wordProblemIndexTwo;
                    ...
                    problemStringOne = newProblemStringOne ;
                    problemStringTwo = newProblemStringTwo;
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                buttonIndex = 0;
                wordProblemIndexOne = 0;
                wordProblemIndexTwo = 1;
